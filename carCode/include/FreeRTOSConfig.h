...
// Note: the CPU_CLOCK_HZ parameter is set to the frequency seen by the systick hardware,
// which should be 72MHz/8
#define configCPU_CLOCK_HZ              ( ( unsigned long ) 72000000/8 )
